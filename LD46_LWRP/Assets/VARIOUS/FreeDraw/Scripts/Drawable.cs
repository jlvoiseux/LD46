...
// BRUSH TYPES. Implement your own here
        ...
        public void SetupPaints()
        {
            ...
            clean_colours_array = drawable_sprite.texture.GetPixels(0, 0, drawable_sprite.texture.width, drawable_sprite.texture.height);
            cur_colors = drawable_texture.GetPixels32();
            und_colors = underTexture.GetPixels32();
        }
...
//////////////////////////////////////////////////////////////////////////////
        ...
        void Update()
        {
            ...
            if (mouse_held_down && !no_drawing_on_current_drag)
            {
                ...
                Vector2 mouse_world_position = tipPosition.position;
            ...
            if (numberErased > prop * drawable_texture.height * drawable_texture.height)
            {
                isErased = true;
            }
        }
        ...
        public void MarkPixelToChange(int x, int y, Color color)
        {
            ...
            cur_colors[array_pos] = und_colors[array_pos];
            numberErased += 1;
        }
